...
gboolean on_key_press(GtkWidget *widget, GdkEventKey *event, gpointer user_data)
{
    ...
    {
        game->p1.event = g_timeout_add(PADDLE_PERIOD, paddle_move_up1, game);
        return TRUE;
    }
    ...
    {
        game->p1.event = g_timeout_add(PADDLE_PERIOD, paddle_move_down1, game);
        return TRUE;
    }
    ...
    {
        if (game->p1.even != NULL)
        {
            game->p1.event = g_timeout_add(PADDLE_PERIOD, paddle_move_up2, game);
            return TRUE;
        }
    }
    ...
    {
        if (game->p1.event != NULL)
            game->p1.event = g_timeout_add(PADDLE_PERIOD, paddle_move_down2, game);
        return TRUE;
    }
